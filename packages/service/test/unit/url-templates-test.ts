...
import { encodeWebId, decodeWebId, webId2agentUrl, agentUrl2webId, agentRedirectUrl, webhookTargetUrl } from '../../src/url-templates'
...
test('webhookTargetUrl', () => {
  expect(webhookTargetUrl(webId, peerWebId)).toEqual('http://localhost:4000/agents/aHR0cHM6Ly9hbGljZS5leGFtcGxl/webhook/aHR0cHM6Ly9ib2IuZXhhbXBsZQ==')
})
