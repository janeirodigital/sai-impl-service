...
import { CRUDApplicationRegistration, ReadableAccessAuthorization, ReadableAccessNeedGroup, ReadableClientIdDocument } from '@janeirodigital/interop-data-model'
...
describe('getDescriptions', () => {
  ...
  test('returns well formatted descriptions', async () => {
    ...
    saiSession.factory.readable.clientIdDocument.mockResolvedValueOnce({ hasAccessNeedGroup: accessNeedGroup.iri} as unknown as ReadableClientIdDocument)
